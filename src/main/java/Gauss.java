...
public class Gauss {
	 ...
	 *
	 * @param x1 = the X-Coord of the 1. Corner
	 * @param y1 = the Y-Coord of the 1. Corner
	 * @param x2 = the X-Coord of the 2. Corner
	 * @param y2 = the Y-Coord of the 2. Corner
	 * @param x3 = the X-Coord of the 3. Corner
	 * @param y3 = the Y-Coord of the 3. Corner
	 */
